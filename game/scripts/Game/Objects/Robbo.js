...
(function() {
  ...
  app.Robbo = (function(_super) {
    ...
    function Robbo(envCtx, x, y) {
      ...
      this.eventAggregator.subscribe('arrow-down', ((function(_this) {
        return function(args) {
          return _this.arrowDown(args);
        };
      })(this)), this);
      this.eventAggregator.subscribe('ammo-collected', ((function(_this) {
        return function(count) {
          return _this.ammo += count;
        };
      })(this)));
      this.eventAggregator.subscribe('bolt-collected', ((function(_this) {
        return function() {
          return _this.bolts++;
        };
      })(this)));
      this.eventAggregator.subscribe('key-collected', ((function(_this) {
        return function() {
          return _this.keys++;
        };
      })(this)));
      this.eventAggregator.subscribe('key-used', ((function(_this) {
        return function() {
          return _this.keys--;
        };
      })(this)));
    ...
    Robbo.prototype.makeMove = function(direction) {
      ...
      if (this.isActive) {
        this.envCtx.delay(app.Predef.Robbo.changeStateDelay, (function(_this) {
          return function() {
            if (_this.isActive) {
